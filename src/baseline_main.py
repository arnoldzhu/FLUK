from tqdm import tqdm       # a progress bar in python
...
from update import test_inference, my_test
from models import MNIST_2NN, MLP, MNIST_CNN, CNNMnist, CNN_FMNIST, CNNFashion_Mnist, CNNCifar
